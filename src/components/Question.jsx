...
export const Question = () => {
	...
	return (
		<>
			...
			{typeQ === 'flag' && <Image src={correctAnswer.flag} alt={correctAnswer.name} />}
			...
			{typeQ === 'currency' ? (
				...
				<>
					<Answer
						...
						correctText={
							answersQuest === correctAnswer.currencies[0].name ? 'True' : 'False'
						}
					...
					<Answer
						...
						correct={answersQuest !== correctAnswer.currencies[0].name}
						correctText={
							answersQuest !== correctAnswer.currencies[0].name ? 'False' : 'True'
						}
						setTextSelect={setTextSelect}
						textSelect={textSelect}
					/>
